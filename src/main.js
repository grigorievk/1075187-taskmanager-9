...
(function() {
  ...
  const searchTpl = `<section class="main__search search container">
        <input
          type="text"
          id="search__input"
          class="search__input"
  ...
  const filterListTpl = `<section class="main__filter filter container">
        <input
          type="radio"
          id="filter__all"
  ...
  const contentTpl = `<section class="board container">
         <div class="board__tasks"></div>
    </section>`;
  const addCardFormTpl = `<article class="card card--edit card--black">
  ...
  const cardTpl = `<article class="card card--black">
